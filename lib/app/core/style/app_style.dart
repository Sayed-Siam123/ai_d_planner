...
enum LanguageSelect { gilroy, kalnia, exo_2, poppins }
...
TextStyle textHeaderStyle(context,
  ...
  var isBangla = EasyLocalization.of(context)!.locale.toString() ==
          LocalConstants.bdLocalCode
      ? true
      : false;
...
TextStyle textRegularStyle(context,
  ...
  return languageSelect == LanguageSelect.exo_2
      ? GoogleFonts.exo2(
          shadows: isShadowRequired
              ? [
                  Shadow(
      ...
      : languageSelect == LanguageSelect.poppins
          ? GoogleFonts.poppins(
              shadows: isShadowRequired
                  ? [
                      Shadow(
          ...
          : TextStyle(
              ...
              decorationColor: color,
              fontFamily:
                  languageSelect == LanguageSelect.gilroy ? 'Gilroy' : 'Kalnia',
              fontFamilyFallback: ['Gilroy']
              //height: needHeight ? 1.0 : 0.0
              );
}
...
final hintStyle = GoogleFonts.anekBangla(
    fontSize: 14.sp,
    color: AppColors.textGrayShade4,
